...
interface ILiquidityPool {
    function addInitialLiquidity(uint256 _assetOneAmount, uint256 _assetTwoAmount) external;
    function addLiquidity(address _asset, address _secondAsset, uint256 _amount) external;
    ...
    function getSwapQuantity(address sellingAsset, uint256 _amount) external view returns (uint256);
