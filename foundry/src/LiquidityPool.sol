...
contract LiquidityPool is ReentrancyGuard {
    ...
    function addInitialLiquidity(
       ...
       require(initialLiquidityProvidedTime[owner] == 0, "initialLiquidityAlreadyProvided");
...
function removeLiquidity(uint256 _amount) public nonReentrant {
    ...
    uint256 percentageOfUserLiquidity = (percentageOfLiquidity * _amount) / 100;
    ...
    require(
        !(msg.sender == owner && !isTimeInitialLiquidity() && 
